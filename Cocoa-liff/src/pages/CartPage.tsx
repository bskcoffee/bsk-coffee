            ...
            >
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  {[
                    ci.selectedOptions['ความหวาน'],
                    ci.selectedOptions['บรรจุภัณฑ์'],
                    ci.selectedOptions['__milk__']
                      ? (() => { try { return JSON.parse(ci.selectedOptions['__milk__']).name } catch { return null } })()
                      : null,
                    ci.selectedOptions['หมายเหตุ'],
                  ].filter(Boolean).join(' · ')}
                </p>
              </div>
              {/* Qty controls */}
